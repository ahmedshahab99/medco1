...
type AppointmentsByDoctorChartProps = {
...
export function AppointmentsByDoctorChart({ data }: AppointmentsByDoctorChartProps) {
        ...
        {visibleData.length === 0 ? (
          ...
          <ResponsiveContainer width="100%" height={250}>
            ...
            >
              ...
              />
              <Bar dataKey="totalAppointments" radius={[0, 6, 6, 0]} maxBarSize={32}>
