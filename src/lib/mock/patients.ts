...
export const MOCK_PATIENTS: Patient[] = [
  {
    ...
    files: [
      { id: "F001", name: "تخطيط القلب - مارس 2026.pdf", type: "pdf", size: "1.2 MB", date: "2026-03-20", appointmentId: "V001", uploaderName: "د. سارة الخالد" },
      { id: "F002", name: "تحليل الدم الشامل.pdf", type: "lab", size: "540 KB", date: "2026-02-14", appointmentId: "V002", uploaderName: "أحمد (موظف استقبال)" },
      { id: "F003", name: "صورة أشعة الصدر.jpg", type: "image", size: "3.4 MB", date: "2025-12-05", appointmentId: "V004", uploaderName: "د. محمد العمري" },
    ],
    communications: [
  ...
  },
  {
    ...
    files: [
      { id: "F010", name: "نتيجة MRI الدماغ.pdf", type: "pdf", size: "8.1 MB", date: "2026-03-25", appointmentId: "V010", uploaderName: "مركز الأشعة" },
    ],
    communications: [
  ...
  },
  {
    ...
    files: [
      { id: "F020", name: "تحليل HbA1c مارس.pdf", type: "lab", size: "210 KB", date: "2026-03-18", appointmentId: "V020", uploaderName: "المختبر" },
      { id: "F021", name: "تحليل الكلى الشامل.pdf", type: "lab", size: "310 KB", date: "2026-03-18", appointmentId: "V020", uploaderName: "المختبر" },
    ],
    communications: [
  ...
  },
  {
    ...
    files: [
      { id: "F040", name: "الفحص الشامل 2026.pdf", type: "pdf", size: "2.8 MB", date: "2026-03-22", appointmentId: "V040", uploaderName: "د. محمد العمري" },
      { id: "F041", name: "تخطيط القلب.pdf", type: "pdf", size: "900 KB", date: "2026-02-18", appointmentId: "V041", uploaderName: "د. محمد العمري" },
    ],
    communications: [],
  },
  {
  ...
  },
  {
    ...
    notes: [],
    files: [
      { id: "F060", name: "تحاليل أغسطس 2025.pdf", type: "lab", size: "460 KB", date: "2025-08-20", appointmentId: "V061", uploaderName: "المختبر" },
    ],
    communications: [
  ...
  },
  {
    ...
    files: [
      { id: "F070", name: "تحاليل هرمونات.pdf", type: "lab", size: "380 KB", date: "2026-03-15", appointmentId: "V070", uploaderName: "المختبر" },
    ],
    communications: [
  ...
  },
  {
    ...
    files: [
      { id: "F080", name: "تقرير القسطرة - مارس 2026.pdf", type: "pdf", size: "5.2 MB", date: "2026-03-26", appointmentId: "V080", uploaderName: "د. محمد العمري" },
      { id: "F081", name: "تخطيط قلب يناير.pdf", type: "pdf", size: "1.1 MB", date: "2026-01-05", appointmentId: "V082", uploaderName: "د. محمد العمري" },
    ],
    communications: [
  ...
  },
  {
    ...
    files: [
      { id: "F110", name: "تحاليل الغدة الدرقية.pdf", type: "lab", size: "280 KB", date: "2026-03-12", appointmentId: "V110", uploaderName: "المختبر" },
    ],
    communications: [],
  },
];
